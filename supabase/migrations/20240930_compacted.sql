/* NOTE(johnny): This was produced via:

  pg_dump postgresql://postgres:${PASSWORD}@db.eyrcnmuzzyriypdajwdk.supabase.co:5432/postgres \
...
--
-- Name: publication_specs_ext; Type: VIEW; Schema: public; Owner: authenticated
--

CREATE VIEW public.publication_specs_ext WITH (security_invoker='on') AS
 SELECT p.live_spec_id,
    ...
    u.avatar_url AS user_avatar_url,
    l.data_plane_id
   FROM (public.publication_specs p
     JOIN public.live_specs l ON (((p.live_spec_id)::macaddr8 = (l.id)::macaddr8))),
    LATERAL public.view_user_profile(p.user_id) u(user_id, email, full_name, avatar_url);


ALTER VIEW public.publication_specs_ext OWNER TO authenticated;

--
-- Name: VIEW publication_specs_ext; Type: COMMENT; Schema: public; Owner: authenticated
--

COMMENT ON VIEW public.publication_specs_ext IS 'View of `publication_specs` extended with metadata of its user';
...
--
-- Name: TABLE publication_specs_ext; Type: ACL; Schema: public; Owner: authenticated
--
